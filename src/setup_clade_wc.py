"""
this is for the worldchecklist project with miao
"""
import os
import sys
...
if __name__ == "__main__":
    ...
    #may need to change this for WC
    if taxalistf != None:
    ...
    os.system(cmd)
    cmd = py+" "+DI+"populate_dirs_first_wc.py "+tname+" "+dirl+" "+db
    if taxalistf != None:
        cmd += " "+taxalistf
    ...
    if os.path.isfile("log.md.gz"):
        os.remove("log.md.gz")
    cmd = py+" "+DI+"cluster_tree_wc.py "+dirl+"/"+trn+"/ "+logfile
    os.system(cmd)
