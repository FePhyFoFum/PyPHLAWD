...
import sys
import tree_reader
from get_subset_genbank_wc import make_files_with_id as mfid
from get_subset_genbank_wc import make_files_with_id_internal as mfid_in
from get_subset_genbank_wc import make_files_with_id_justtable as mfid_justtable
